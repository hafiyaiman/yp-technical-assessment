...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="bg-zinc-100 font-sans text-zinc-950 antialiased">
        <div class="min-h-screen lg:grid lg:grid-cols-[220px_minmax(0,1fr)]">
            <aside class="border-b border-zinc-200 bg-white lg:fixed lg:inset-y-0 lg:left-0 lg:w-[220px] lg:border-b-0 lg:border-r">
                <div class="flex h-16 items-center gap-3 px-5">
                    <span class="flex h-9 w-9 items-center justify-center rounded-xl bg-zinc-950 text-sm font-semibold text-white">YP</span>
                    <div>
