<div class="space-y-6 px-4 py-6 sm:px-6 lg:px-8">
    <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <div>
            <h1 class="text-2xl font-semibold text-zinc-950 dark:text-white">Activity History</h1>
    ...
    @php($logs = $this->activityLogs())

    <x-card>
        <div class="flex items-start justify-between gap-3">
            <div>
                <h2 class="text-base font-semibold text-zinc-950 dark:text-white">Exam Events</h2>
                <p class="mt-1 text-sm text-zinc-500 dark:text-dark-300">
                    Saves, publishing, submissions, grading, and status changes for this exam.
                </p>
            </div>
            <x-badge text="{{ $logs->total() }} events" icon="clock" color="gray" light />
        </div>
