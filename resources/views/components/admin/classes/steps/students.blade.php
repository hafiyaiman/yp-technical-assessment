        ...
        <div class="flex flex-col gap-1 sm:flex-row sm:items-end sm:justify-between">
            <div>
                ...
                <p class="text-xs text-zinc-500 dark:text-dark-300">
                    Tick students who should belong to this class. Unticked students currently in this class will be removed from it.
                </p>
            </div>
            <x-badge :text="count($studentIds) . ' selected'" color="blue" light />
        </div>

        <div class="mt-3 grid max-h-80 gap-2 overflow-y-auto rounded-md border border-zinc-200 p-2 dark:border-dark-600">
            ...
            @empty
                <p class="px-2 py-3 text-sm text-zinc-500 dark:text-dark-300">
                    Create student users before enrolling them.
                </p>
            @endforelse
        </div>
    </div>
